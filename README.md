# [JOURNIX (formerly Life RPG)](https://anirudhjha982.github.io/To-Do/)

> “Your Journey, Gamified.”

JOURNIX transforms boring real-world productivity tasks into RPG quests. Complete quests to earn XP, collect Gold, level up your character, and build your real-life attributes!
...
Set your `DATABASE_URL` in `.env` (defaults to local SQLite file: `./dev.db`).
